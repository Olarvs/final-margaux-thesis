...
$column = array('orderId', 'billingFullName', 'billingContactNum', 'referenceNum', 'email', 'pickupDateTime', 'orderDateTime', 'orderTotal', 'orderStatus');
...
WHERE tbl_order.deliveryMethod = 'PICK UP' AND tbl_order.paymentMethod = 'GCASH' AND (tbl_order.orderStatus != 'COMPLETED' AND tbl_order.orderStatus != 'CANCELLED')";
