...
WHERE tbl_order.deliveryMethod = 'DELIVERY' AND tbl_order.courier = 'LBC EXPRESS' AND tbl_order.lbcMode = 'DOOR-TO-DOOR' AND tbl_order.paymentMethod = 'GCASH' AND (tbl_order.orderStatus != 'COMPLETED' AND tbl_order.orderStatus != 'CANCELLED')";
