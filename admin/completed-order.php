                ...
                <div class="card">
                    <div class="card-body" style="width: 100%;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="completedOrder" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th>
                                            <center>
...
$(document).ready(function() {
    ...
    // DATATABLES
    $('#completedOrder').css('text-align', 'center');
    var datatable = $('#completedOrder').DataTable({
        // "processing": true,
        "serverSide": true,
        "paging": true,
        "pagingType": "simple",
        ...
        "sScrollXInner": "100%",
        "ajax": {
            url: "./tables/completed-order.php",
            type: "post",
